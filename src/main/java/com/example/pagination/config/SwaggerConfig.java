...
public class SwaggerConfig {
	...
	public Docket postsApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apiInfo(apiInfo())
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.example.pagination"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Pagination API")
				.description("Pagination API reference for developers")
